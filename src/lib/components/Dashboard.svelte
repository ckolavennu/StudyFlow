...
<section class="mx-auto max-w-6xl">
	<header class="glass-card flex flex-col gap-5 rounded-3xl p-6 sm:flex-row sm:items-start sm:justify-between">
		<div class="min-w-0 flex-1">
			...
			<p class="mt-2 text-sm text-white/65">
				{ownerAccessEnabled
					? 'View platform users and StudyFlow activity from your owner dashboard.'
	...
	{#if selectedAssignment && $authState.user && !ownerAccessEnabled}
